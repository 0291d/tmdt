...
class OrderResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table->columns([
            Tables\Columns\TextColumn::make('customer.phone')->label('Khach hang')->searchable(),
            Tables\Columns\TextColumn::make('coupon.code')->label('Ma giam gia'),
